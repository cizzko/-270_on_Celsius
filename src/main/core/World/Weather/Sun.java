...
public class Sun extends GameObject {
    ...
    @Override
    public void draw() {
        StackfulRender.draw(skyBackgroundTex, skyColor.rgba8888(), 0, 0);
        StackfulRender.blending(Render.BLENDING_PREMUL);
        StackfulRender.draw(sunsetTex, sunsetColor.rgba8888(), 0, 0);
        StackfulRender.draw(sunTex, sunColor.rgba8888(), x, y);
