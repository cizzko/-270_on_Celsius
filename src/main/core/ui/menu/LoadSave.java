...
public final class LoadSave extends core.ui.widget.Dialog {
    ...
    // private CreatePlanet.GenerationParameters parameters = new CreatePlanet.GenerationParameters();
    // private TextArea consoleBox;
    ...
    public LoadSave() {
        ...
        loadSave = sizePanel.addButton(Styles.SIMPLE_TEXT_BUTTON, () -> WorldGenerator.generateWorld(parameters))
                .set(1460, 260, 420, 65)
                .setName(Global.lang.get("Load save"))
                .setOneShot(true);
